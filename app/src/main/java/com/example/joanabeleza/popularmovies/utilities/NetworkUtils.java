...
public class NetworkUtils {
    ...
    final static String API_KEY = "na";
    ...
    public static String[] getMovieTrailers(String movieTrailersJsonStr) throws JSONException {
        ...
        for (int i = 0, j = 0; i < movieArray.length(); i++, j++) {
            ...
            if (type.equals("Trailer")) {
                ...
                parsedMovieData[j] = "https://www.youtube.com/watch?v=" + key;
            }
